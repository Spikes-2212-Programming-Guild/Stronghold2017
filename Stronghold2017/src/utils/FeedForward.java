...
public class FeedForward {
	...
	public FeedForward(double p, double maxV, double maxA, double maxD, double setpoint) {
		...
		if (dt2 < 0) {
			dt2 = 0;
			dt3 = Math.sqrt((2 * setpoint * maxA) / maxD * (maxD - maxA));
			dt1 = -(maxD * dt3) / maxA;
		}
	...
	public double[] getExpected(double t) {
		...
		return new double []{maxA*dt1*dt1+maxV*dt2+(maxV-dt1-dt2)+0.5*maxD*Math.pow(t-dt1-dt2,2),maxV+maxD*(t-dt1-dt2),maxD};
		}
